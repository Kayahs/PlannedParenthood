    ...
    <div id="primary" class="content-area contact-page">
      ...
      <?php while ( have_posts() ) : the_post(); ?>
        ...
        <div class="entry-content">
          ...
          <p><a href="<?php echo get_template_directory_uri() .'/assets/PDF/contact/How-to-make-a-complaint.pdf' ?>">Download our How To Make A Complaint instructions</a></p>
          <p><a href="<?php echo get_template_directory_uri() .'/assets/PDF/contact/CLIENT-COMPLAINT-REPORTING-FORM.pdf' ?>">Download our Client Complaint Reporting Form</a></p>
          <p><a href="<?php echo get_template_directory_uri() .'/assets/PDF/contact/PART-16-Client-Complaint.pdf' ?>">Download our Client Complaint Policy and Procedures</a></p>
          <p><a href="<?php echo get_template_directory_uri() .'/assets/PDF/contact/WORKPLACE-HSD.pdf' ?>">Download our Workplace Harassment, Solicitation and Discrimination Policy</a></p>
        </div><!-- .entry-content -->
